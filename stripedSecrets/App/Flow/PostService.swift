...
class PostRequestService {
    ...
    private let baseUrl = "https://striped-secrets.br-soft.online/api/user/balance-update"
    ...
    func createPlayerUser(username: String) async throws -> PlayerNetworkModel {
           ...
           let urlString = "https://striped-secrets.br-soft.online/api/user?password=\(password)&username=\(username)"
